...
mod tests {
    use super::{
        normalize_provider_name, provider_default_base_url, provider_env_vars,
    ...
    #[test]
    fn openai_compatible_has_only_approved_env_vars() {
        assert_eq!(
            provider_env_vars(OPENAI_COMPATIBLE_PROVIDER),
            vec!["RAI_OPENAI_COMPAT_API_KEY", "OPENAI_COMPAT_API_KEY"]
        );
    }
